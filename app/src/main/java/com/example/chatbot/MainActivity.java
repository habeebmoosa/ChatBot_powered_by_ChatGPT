...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        chatAdapt = new chatAdapter(messageList);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        menuInflater.inflate(R.menu.api_insert_key_menu,menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
       ...
       builder.setMessage("Insert your OpenAI API key below");
       ...
       builder.setView(inputKey);
        ...
        builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                API_Key = inputKey.getText().toString();
            }
        });
        builder.show();
    ...
    void API_call(String msg){
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onFailure(@NonNull Call call, @NonNull IOException e) {
                addResponse("Failed to load message due to this reason "+e.getMessage());
            }

            @Override
            public void onResponse(@NonNull Call call, @NonNull Response response) throws IOException {
                if(API_Key.isEmpty()){
                    addResponse("First add the API key");
                }
                    ...
                    addResponse("Failed to load message due to this reason "+response.body().toString());
                }
            }
        });
    }
